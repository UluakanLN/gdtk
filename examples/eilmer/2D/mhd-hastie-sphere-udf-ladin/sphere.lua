...
setHistoryPoint{x=-1.10*R,y=0.0} -- nearest cell ID 161 --> point that is farthest from the stagnation point on the sphere surface
...
config.cfl_value = 0.1 -- to get better chemistry-gas-dynamics coupling
